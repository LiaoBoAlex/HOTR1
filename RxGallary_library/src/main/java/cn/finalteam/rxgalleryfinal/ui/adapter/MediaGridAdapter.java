...
public class MediaGridAdapter extends RecyclerView.Adapter<MediaGridAdapter.GridViewHolder> {
    ...
    public GridViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (imageLoaderType != 3) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.gallery_item_gallery_media_grid, parent, false);
        } else {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.gallery_item_gallery_media_grid_fresco, parent, false);
        }
